        ...
        <li>
            ...
            <div className={classnames('row', {
                ...
                <span className={classnames('station', {
                    red: isDepartStation || isArriveStation
                })}>
                    {station}
                </span>
...
const Schedule = memo(function Schedule(props) {
    ...
    useEffect(() => {
        ...
        fetch(url)
            ...
            .then(data => {
                // departRow表示出发车站，arriveRow表示到达车站
                let departRow;
                let arriveRow;

                for(let i = 0; i < data.length; ++i) {
                    // 遍历寻找stations，如果没有找到出发车站，要么当前车站在出发车站前，要么当前车站就是出发车站
                    if (!departRow) {
                    ...
                    // 如果没找到到达车站，要么当前车站就是到达车站，要么当前车站在出发车站和到达车站之间
                    } else if (!arriveRow) {
                    ...
                    // 如果既找到了出发车站又找到了到达车站，那么当前车站一定在到达车站之后；
                    } else {
                        Object.assign(data[i], {
                            beforeDepartStation: false,
                            isDepartStation: false,
